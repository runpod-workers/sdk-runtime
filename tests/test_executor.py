...
from runpod_sdk_runtime import executor
...
class TestSdkSourceIntegration:
    def test_decorated_handle_resolves_to_function(self):
        code = (
            "import runpod\n"
            "app = runpod.App('t')\n"
            "@app.queue()\n"
    ...
    def test_materialized_module_supports_nested_source_extraction(self):
        code = (
            "import runpod\n"
            "app = runpod.App('t2')\n"
            "@app.queue()\n"
